...
class SiteOrigin_Settings_Control_Premium extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<p>
			<?php
			printf(
			__( "SiteOrigin Premium adds powerful features to %s. They'll save you time and make your site more professional.", 'siteorigin-unwind' ),
			$theme->get( 'Name' )
		);
		?>
		</p>
		<a
			...
			target="_blank">
			<?php esc_html_e( 'Find Out More', 'siteorigin-unwind' ); ?>
		</a>
		<?php
	}
